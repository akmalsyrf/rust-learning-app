      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          <Text style={styles.description}>
            A mobile app to learn Rust programming through interactive quizzes, code comprehension
            exercises, and gamified learning with streaks and leaderboards. Perfect for beginners
            starting their Rust journey.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.licenseCard}>
            <Text style={styles.licenseText}>
              This app uses content under CC BY-SA 4.0 license from the source material. All
              original content is properly attributed and linked to its source.
            </Text>
            <Text style={styles.licenseText}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Made with ❤️ by akmalsyrf</Text>
          <Text style={styles.footerText}>© 2025 Rust Learning App</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
