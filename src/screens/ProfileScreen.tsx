      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.achievementsGrid}>
            <View style={[styles.achievement, currentStreakDays >= 3 && styles.achievementUnlocked]}>
              <Ionicons 
                name="flame" 
                size={24} 
                color={currentStreakDays >= 3 ? currentTheme.colors.streak : currentTheme.colors.border} 
              />
              <Text style={[styles.achievementText, currentStreakDays >= 3 && styles.achievementTextUnlocked]}>
                3-Day Streak
              </Text>
            </View>
            ...
            <View style={[styles.achievement, totalCorrect >= 10 && styles.achievementUnlocked]}>
              <Ionicons 
                ...
                size={24} 
                color={totalCorrect >= 10 ? currentTheme.colors.success : currentTheme.colors.border} 
              />
              <Text style={[styles.achievementText, totalCorrect >= 10 && styles.achievementTextUnlocked]}>
                10 Correct
              </Text>
            </View>
          </View>
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.progressStats}>
            <View style={styles.progressStat}>
              <Text style={styles.progressStatValue}>{Math.round((totalCorrect / Math.max(totalCorrect + 5, 1)) * 100)}%</Text>
